...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
function counter() {
  ...
  switch (action.type) {
    ...
    case "done":
      return state = state.map(function (t) {
        if (t.id == action.id) {
          t.completed = true;
        }
...
store.subscribe(function () {
  ul.innerHTML = "";
  store.getState().forEach(function (t) {
...
//   if(t.id == )
// })
},{"redux":"node_modules/redux/es/redux.js"}],"../../../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
